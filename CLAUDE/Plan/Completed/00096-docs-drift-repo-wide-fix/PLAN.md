# Plan 00096: Repo-Wide Documentation Drift Fix
...
Plan 00095 documented CCY and reconnected the front page to the docs tree. In doing so it
...
- Not a style, tone or restructuring pass — Plan 00095 already did the structural work.
...
<!-- Curated milestones + delivery commit hashes only (git is the SSoT for
     ...
     JOURNAL/00096-Journal-YY-MM-DD.md — see CLAUDE/PlanJournalling.md. -->

- Recovery cron: `e85368fc` (carried over from Plan 00095, same session)
- Precursor: Plan 00095 (`d52fad1`) found the Docker core/rootful drift that motivated this
