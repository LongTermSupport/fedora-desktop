#!/usr/bin/env bash
#
# Plan 00094 — deploy the rclone RC auth change. HOST ONLY.
#
...
echo "=============================================================="
echo "Plan 00094 — deploying rclone RC authentication"
echo "=============================================================="
echo
...
echo "  CLAUDE/Plan/00094-rclone-rc-auth-instead-of-no-auth/acceptance.bash"
echo "=============================================================="
