#!/usr/bin/env bash
#
# Plan 00097 acceptance — the PASS/FAIL gate for the two-engine browser stack.
#
...
usage() {
    cat <<'USAGE'
Plan 00097 acceptance — pass/fail gate for the CCY two-engine browser stack.
...
echo "==============================================================================="
echo " Plan 00097 — browser engine ACCEPTANCE"
...
echo "  ACCEPTED — the shipped image delivers what Plan 00097 promised."
echo
echo " Full log: $LOG"
echo "==============================================================================="
