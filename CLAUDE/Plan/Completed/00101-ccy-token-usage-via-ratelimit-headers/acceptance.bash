#!/usr/bin/env bash
#
# Plan 00101 — acceptance: did the deploy actually land, and is the feature wired?
#
...
#
# WHY THIS EXISTS: Plan 00100's deploy ran green against the WRONG play, so the
...
usage() {
    cat <<'EOF'
Plan 00101 acceptance — confirm the on-demand usage feature is deployed
...
if [ ! -f "$DEPLOYED_LIB" ]; then
    ...
    echo "     This is the Plan 00100 failure mode. Remedy: run deploy.bash" >&2
fi
echo ""
