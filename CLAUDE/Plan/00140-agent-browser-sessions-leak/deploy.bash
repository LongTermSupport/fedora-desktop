...
#   browsing skill and CCY-GUIDE into /opt/claude-yolo, installs the CCY 3.67.5 launcher,
...
Runs, on the HOST:
  ...
  playbooks/imports/play-claude-yolo.yml   (guard staged, launcher 3.67.5, image rebuilt)
