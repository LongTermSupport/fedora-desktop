#!/usr/bin/env bash
#
# Plan 00098 — acceptance gate for the Claude Code state permission work.
#
...
usage() {
    cat <<'EOF'
Plan 00098 acceptance gate — verify Claude Code state is owner-only.
...
echo "=========================================================="
echo " Plan 00098 — acceptance gate"
