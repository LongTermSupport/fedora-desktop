#!/usr/bin/env bash
#
# Plan 00098 — Claude Code state posture triage.
#
...
usage() {
    cat <<'EOF'
Plan 00098 triage — report the on-disk posture of Claude Code state.
...
echo "=========================================================="
echo " Plan 00098 — Claude Code state posture triage"
