#!/usr/bin/env bash
#
# Plan 00101 — deploy the on-demand token usage display (CCY 3.34.0).
#
...
# than in chat is deliberate: Plan 00100 was told to deploy play-claude-code.yml,
...
usage() {
    cat <<'EOF'
Plan 00101 deploy — install the on-demand token usage display on this host
...
echo "Deploying Plan 00101 via play-claude-yolo.yml ..." >&2
echo "" >&2
