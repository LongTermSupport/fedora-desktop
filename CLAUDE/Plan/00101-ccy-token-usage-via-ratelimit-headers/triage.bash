#!/usr/bin/env bash
#
# Plan 00101 — triage: what is the API actually sending for `-utilization`?
#
...
usage() {
    cat <<'EOF'
Plan 00101 triage — establish the scale of anthropic-ratelimit-unified-*-utilization
...
echo "════════════════════════════════════════════════════════════════════"
echo " Plan 00101 triage — utilisation scale"
echo "════════════════════════════════════════════════════════════════════"
echo ""
