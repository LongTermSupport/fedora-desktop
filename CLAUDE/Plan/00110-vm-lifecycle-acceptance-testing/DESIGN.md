...
| `download.fedoraproject.org` is a redirector and mirrors differ per request            | three consecutive HEADs resolved to three different mirrors (`mirror-a`, `mirror-b`, `mirror-c`)                                                                                                    |
...
| **HTTP `Last-Modified` / `ETag` on an ISO**                    | Mirror-dependent. Three consecutive HEADs redirected to three different mirrors (`mirror-a`, `mirror-b`, `mirror-c`). Timestamps differ per mirror; content hashes do not.                                                                                                                                    |
