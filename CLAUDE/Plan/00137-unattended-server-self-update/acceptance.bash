...
NOT_ESTABLISHABLE=(
    ...
    "An unsigned commit above the signed tip leaves the clone where it is and runs nothing. Signing is on by default (Plan 00139), so make that commit with 'git -c commit.gpgsign=false commit ...'."
