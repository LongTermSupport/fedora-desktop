#!/usr/bin/env bash
#
# Plan 00072 — acceptance gate. Renders a VERDICT (unlike triage.bash, which
# only reports facts).
#
...
echo "=============================================================="
echo "Plan 00072 acceptance — rclone RC clients"
echo "=============================================================="
echo
...
# endpoint Plan 00067 correctly identified as gated — so it is the one call whose
