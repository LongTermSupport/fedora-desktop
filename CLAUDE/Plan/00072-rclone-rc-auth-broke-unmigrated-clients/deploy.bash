#!/usr/bin/env bash
#
# Plan 00072 — deploy the RC credential helper and every migrated client.
# HOST ONLY.
#
# Runs BOTH plays, and that pairing is the point. Plan 00067 changed
...
for arg in "$@"; do
    case "$arg" in
        -h | --help)
            cat << 'EOF'
Plan 00072 — deploy the rclone RC client migration (HOST ONLY)
...
echo "=============================================================="
echo "Plan 00072 — deploying the rclone RC client migration"
echo "=============================================================="
echo
