#!/usr/bin/env bash
#
# Plan 00100 — deploy the ccy token-usage changes.
#
...
# the host kept the old library, which is exactly the Plan 00099 failure mode
...
usage() {
    cat <<'EOF'
Plan 00100 deploy — install the ccy token-usage changes on this host
...
echo "Deploying Plan 00100 via play-claude-yolo.yml ..." >&2
echo "" >&2
