...
check "Permissive"  "true"   permissive "Permissive host, engine labelling: nothing is refused, but every read is logged, so relabel"
check "Permissive"  "false"  off       "Permissive host, engine not labelling: containers run unconfined, nothing to log"
check "Permissive"  ""       unknown   "Permissive host, engine report empty"
