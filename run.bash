...
RUN_BASH_VERSION="1.6.1"  # Fix: promptForValue confirm prompt rendered raw escape codes (echo -en then bare read); vault probe via process-substitution (no /tmp); EOF aborts vault prompt instead of spinning
set -e
set -u
set -o pipefail
IFS=$'\n\t'
